...
#define CUI_APP_MENU    CUI_MENU_ITEM_ACTION("<  TOGGLE LIGHT  >", (CUI_pFnAction_t) zclSampleLight_UiActionToggleLight)    \
                        CUI_MENU_ITEM_ACTION("<    DISCOVER    >", (CUI_pFnAction_t) zclSampleLight_UiActionSwitchDiscovery)
#else

#define SAMPLE_APP_MENUS  3
#define CUI_APP_MENU    CUI_MENU_ITEM_ACTION("<  TOGGLE LIGHT  >", (CUI_pFnAction_t) zclSampleLight_UiActionToggleLight)     \
                        CUI_MENU_ITEM_ACTION("<    DISCOVER    >", (CUI_pFnAction_t) zclSampleLight_UiActionSwitchDiscovery) \
                        CUI_MENU_ITEM_ACTION("< GPS COMMISSION >", (CUI_pFnAction_t) zclSampleLight_setGPSinkCommissioningMode)


#endif

#define APP_TITLE_STR "TI Sample Light"
